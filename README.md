...
Misc files - Folder of backup and working files used such as standalone diagrams and other saved things used throughout the project. 

Test Data - All raw output data from lab and analysis working files (excel)

Deliveries - All final deliveries of the project including a recorded presentation overview and the final results paper.
